...
```
The json parameter file has 2 sections

1: Connections: an array of json objects with the definition below
...
2: Tasks: an array of json objects with definitions below
